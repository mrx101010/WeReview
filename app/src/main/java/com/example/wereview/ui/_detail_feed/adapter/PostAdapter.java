package com.example.wereview.ui._detail_feed.adapter;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(PostAdapter.ViewHolder holder, int position) {
        ...
        holder.tvAkun.setText(post.getUserId());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        public TextView tvAkun, tvCaption, tvDescription;
        public ImageView ivFeed;

        public ViewHolder(View itemView) {
            super(itemView);
            tvAkun = (TextView) itemView.findViewById(R.id.akun);
            tvCaption = (TextView) itemView.findViewById(R.id.caption);
            tvDescription = (TextView) itemView.findViewById(R.id.tv_description);
            ivFeed = (ImageView) itemView.findViewById(R.id.iv_detail_feed_photo);
